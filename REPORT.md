...
Renders: `mv_example_ours_vs_pytorch.png` (ours | PyTorch), `mv_example_sv_vs_mv_vs_pytorch.png` (SV | MV | PyTorch).
...
Observations (gallery: `official_sv_gallery.png`, per-asset 4-view `quad4k/<name>_quad4k.png`, tiles = orbit 0/90/180/270° — the 180° tile is the input view):
