...
extern int  g_fa_kv;            // defined in dit.cpp; --fa-kv   (TRELLIS_FA_KV / TRELLIS_FA_FAST)
...
struct TrellisParams {
    ...
    int  fa_kv    = 0;          // FlashAttention K/V storage type: 0 auto, 1 bf16, 2 f16, 3 f32 (trellis::FaKv)
