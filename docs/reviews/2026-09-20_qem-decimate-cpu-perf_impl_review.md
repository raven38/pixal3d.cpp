...
1. Emscripten でも環境変数により並列実行でき、非 atomic `prop` が競合する  
   [src/decimate_qem.cpp:78](/Users/s25705/Downloads/pixal3d-qem-decimate/src/decimate_qem.cpp:78)、[src/decimate_qem.cpp:260](/Users/s25705/Downloads/pixal3d-qem-decimate/src/decimate_qem.cpp:260)、[parallel_for.h:25](/Users/s25705/Downloads/pixal3d-qem-decimate/include/parallel_for.h:25)
...
2. 「入口で不正面を除去する」という公開契約を pass-through が迂回する  
   [uv_bake.h:55](/Users/s25705/Downloads/pixal3d-qem-decimate/include/uv_bake.h:55)、[src/decimate_qem.cpp:329](/Users/s25705/Downloads/pixal3d-qem-decimate/src/decimate_qem.cpp:329)、[src/decimate_qem.cpp:352](/Users/s25705/Downloads/pixal3d-qem-decimate/src/decimate_qem.cpp:352)
...
- [src/decimate_qem.cpp:254](/Users/s25705/Downloads/pixal3d-qem-decimate/src/decimate_qem.cpp:254) の「cost は非負有限」は浮動小数点上では保証されません。QEM 展開式は大座標で cancellation により負値になり得ます。負の IEEE-754 bit pattern を unsigned 比較すると数値順になりません。legacy と同じ挙動ではありますが、コメントの前提を弱めるか、cost の有限性・非負性を明示的に正規化すべきです。

- [src/test_decimate_cpu.cpp:111](/Users/s25705/Downloads/pixal3d-qem-decimate/src/test_decimate_cpu.cpp:111) の  
...
- `off`、`eoff`、`E` は `int` です。[src/decimate_qem.cpp:148](/Users/s25705/Downloads/pixal3d-qem-decimate/src/decimate_qem.cpp:148) 以降で `3F` や edge 数が `INT_MAX` を超える入力は符号付き overflow になります。対応しないなら最大入力サイズを契約として検査してください。

- [src/decimate_qem.cpp:265](/Users/s25705/Downloads/pixal3d-qem-decimate/src/decimate_qem.cpp:265) の `is_always_lock_free` は正しさには不要で、mutex 実装の atomic が有効なプラットフォームまでコンパイル不能にします。性能上の必須条件なら、対象プラットフォーム限定であることを明示すべきです。
