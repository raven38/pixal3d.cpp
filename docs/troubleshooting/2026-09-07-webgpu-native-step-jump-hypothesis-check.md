...
cd <repo>/web
node texture/run_playwright.js ~/data/weights/pixal3d/gguf/pixal3d_tex_flow_1024_mv.gguf \
...
- 実モデル: GGUF `~/data/weights/pixal3d/gguf/pixal3d_tex_flow_1024_mv.gguf`（元 ckpt は同ディレクトリ
