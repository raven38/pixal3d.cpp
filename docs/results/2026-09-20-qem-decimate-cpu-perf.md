...
fixture: `~/nfs/pixal3d/fixtures/cyclops_mv1024_seed1_post.bin`（501 MB、origin/main の
`trellis-cli --views docker/linux-webgpu-gate/e2e/views -m ~/nfs/weights/pixal3d/gguf-q8_0 --res 1024 --seed 1 --dump-post`
...
F=~/nfs/pixal3d/fixtures/cyclops_mv1024_seed1_post.bin
