...
環境: macOS 26.5 / MacBook Pro M4 Max（64 GB）/ Metal（`MTL0`）。重み `pixal3d-q8_0 v1`（MV、`~/data/weights/pixal3d/gguf-q8_0/`）。
...
`trellis-cli --views docker/linux-webgpu-gate/e2e/views -m ~/data/weights/pixal3d/gguf-q8_0 --res 1024 --seed 1 --profile-cond`。
