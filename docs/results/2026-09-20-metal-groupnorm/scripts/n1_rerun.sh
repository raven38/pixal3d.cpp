...
$REPO/build-metal/trellis-test-naf --gn-oracle $HOME/data/weights/pixal3d/gguf-q8_0/pixal3d_naf.gguf 0 > $D/numerics/n1_metal_sync.log 2>&1; echo "metal exit=$?"
$REPO/build-metal/trellis-test-naf --gn-oracle $HOME/data/weights/pixal3d/gguf-q8_0/pixal3d_naf.gguf -1 > $D/numerics/n1_cpu_sync.log 2>&1; echo "cpu exit=$?"
