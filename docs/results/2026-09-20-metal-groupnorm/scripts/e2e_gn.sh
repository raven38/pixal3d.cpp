...
run() {  # run <arm>
  ...
  run_guarded $OUT/e2e_$arm.log $REPO/build-metal/trellis-cli --views $REPO/docker/linux-webgpu-gate/e2e/views -m $HOME/nfs/weights/pixal3d/gguf-q8_0 --res 1024 --seed 1 --profile-cond $extra -o $OUT/$arm.glb
